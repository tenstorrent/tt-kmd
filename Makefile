...
obj-m += tenstorrent.o
tenstorrent-y := module.o chardev.o enumerate.o interrupt.o wormhole.o blackhole.o fwlog.o fwlog_parser.o msgqueue.o keraunos.o pcie.o sg_helpers.o memory.o tlb.o telemetry.o
