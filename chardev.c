...
static int tenstorrent_set_aggregated_power_state_priv(struct tenstorrent_device *tt_dev)
{
...
int tenstorrent_set_aggregated_power_state(struct tenstorrent_device *tt_dev)
{
	...
	ret = tenstorrent_set_aggregated_power_state_priv(tt_dev);
...
static void tt_cdev_release_power(struct chardev_private *priv)
{
	...
	if (can_defer && last_close)
		...
		tenstorrent_set_aggregated_power_state_priv(tt_dev);
}
