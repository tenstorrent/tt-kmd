...
struct tenstorrent_device_class {
	...
	void (*noc_write8)(struct tenstorrent_device *ttdev, u32 x, u32 y, u64 addr, u8 data, int noc);
	u8 (*noc_read8)(struct tenstorrent_device *ttdev, u32 x, u32 y, u64 addr, int noc);
};
